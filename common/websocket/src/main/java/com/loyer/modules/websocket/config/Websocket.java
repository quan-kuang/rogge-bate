 ...
 * @author kuangq
 * @title Websocket
 * @description Websocket通讯 同步异步说明参考：http://blog.csdn.net/who_is_xiaoming/article/details/53287691
