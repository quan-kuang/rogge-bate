...
public class OperateLogAspect {
     ...
     * @return void
     * @author kuangq
     * @description 根据OperateLogAnnotation注解编织切入点
     ...
     * @param joinPoint
     * @param object
     * @return com.loyer.system.common.entity.OperateLog
     * @author kuangq
     * @description 保存操作日志
    ...
    public OperateLog saveOperateLog(JoinPoint joinPoint, Object object) {
        ...
        //获取请求参数
        operateLog.setUuid(GeneralUtil.getUuid());
        operateLog.setIp(IpUtil.getRealIp(httpServletRequest));
     ...
     * @param inArgs
     * @param object
     * @param operateLogAnnotation
     * @return void
     * @author kuangq
     * @description rabbitmq异步保存
