...
public class BeanUtil extends BeanUtils {
     ...
     * @return void
     * @author kuangq
     * @description Bean属性复制，将source属性复制给target
     ...
     * @return boolean
     * @author kuangq
     * @description 校验两个方法的属性名是否相等，如getName()和setName()属性名一样，getName()和setAge()属性名不一样
