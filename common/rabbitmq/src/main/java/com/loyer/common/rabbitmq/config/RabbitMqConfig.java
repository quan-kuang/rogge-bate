...
public class RabbitMqConfig {
    ...
    public RabbitTemplate rabbitTemplate() {
        ...
        //消息发送失败的回调
        rabbitTemplate.setReturnCallback((message, replyCode, replyText, exchange, routingKey) -> logger.info("【消息发送失败】message({})，replyCode({})，replyText({})，exchange({})，routingKey({})", message, replyCode, replyText, exchange, routingKey));
