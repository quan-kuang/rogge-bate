...
public class ThrottlingAspect {
    ...
    /**
     * @param joinPoint
     * @param throttlingType
     * @return java.lang.String
     * @author kuangq
     * @description 获取缓存key值
    ...
    /**
     * @param joinPoint
     * @return com.loyer.system.framework.throttling.annotation.ThrottlingAnnotation
     * @author kuangq
     * @description 获取切入点的限流注解
    ...
    public Object interceptor(ProceedingJoinPoint joinPoint) {
        ...
        Object result = redisTemplate.execute(redisScript, keys, count, cycle);
        //限流判断 0 = FALSE
