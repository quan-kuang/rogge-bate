...
public class PermissionUtil {
     ...
     * @return void
     * @author kuangq
     * @description 避免返回FALSE会抛出AccessDeniedException异常，直接在全局异常处理器中处理
