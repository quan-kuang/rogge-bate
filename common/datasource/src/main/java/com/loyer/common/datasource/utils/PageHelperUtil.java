...
/**
 * @author kuangq
 * @title PageHelperUtil
 * @description PageHelper工具类
...
public class PageHelperUtil {
    ...
    /**
     * @param object
     * @return com.loyer.common.datasource.entity.PageParams
     * @author kuangq
     * @description 分页参数校验
     ...
     * @param methodName
     * @param params
     * @return com.loyer.common.datasource.entity.PageResult<T>
     * @author kuangq
     * @description 分页查询
