...
public class PdfUtil {
    ...
    /**
     * @param sourcePath 原pdf文件路径
     * @param targetPath 新pdf文件路径
     * @param imgBytes   图片字节数组
     * @param stampGoal  签章目标
     * @param scale      签章图片缩放倍数
     * @param offset     签章位置偏移量
     * @return void
     * @author kuangq
     * @description pdf添加图章
