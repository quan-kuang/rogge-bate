...
public class MethodUtil {
    ...
    /**
     * @param className
     * @return java.util.Set<com.loyer.system.common.entity.MethodEntity>
     * @author kuangq
     * @description 根据完整类名获取该类下所有非私有方法
     * @date 2019-12-13 10:37
     */
    ...
    /**
     * @param params
     * @return com.loyer.system.common.entity.MethodEntity
     * @author kuangq
     * @description map转MethodEntity
