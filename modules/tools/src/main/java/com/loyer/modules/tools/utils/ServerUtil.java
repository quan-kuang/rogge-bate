...
public class ServerUtil {
    ...
    public static class Processor {
         ...
         * @return
         * @author kuangq
         * @description 从CentralProcessor对象获取处理器信息
    ...
    public static class Memory {
         ...
         * @return
         * @author kuangq
         * @description 从GlobalMemory对象中获取内存信息
    ...
    public static class Jvm {
         ...
         * @return
         * @author kuangq
         * @description 从Properties、ManagementFactory对象获取JVM信息
    ...
    public static class Computer {
         ...
         * @return
         * @author kuangq
         * @description 从Properties对象获取服务器信息
    ...
    public static class Disk {
         ...
         * @return
         * @author kuangq
         * @description 从OSFileStore对象中获取单个磁盘信息
     ...
     * @return double
     * @author kuangq
     * @description 单位转换（为保证精度，先做四位舍入，再保存两位）
