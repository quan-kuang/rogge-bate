...
public class JedisUtil {
     ...
     * @author kuangq
     * @description 格式化clientList信息，个别字段key处理
    ...
    /**
     * @param str
     * @return java.util.List<com.loyer.modules.tools.entity.ClusterNode>
     * @author kuangq
     * @description 格式化clusterNodes信息
    ...
    /**
     * @param objectList
     * @return java.util.TreeMap<java.lang.Integer, java.lang.String>
     * @author kuangq
     * @description 格式化槽位信息
    ...
    /**
     * @param jedisEntity
     * @return com.loyer.entity.ApiResult
     * @author kuangq
     * @description 主从模式数据写入
