...
/**
 * @author kuangq
 * @title CodeCaptchaUtil
 * @description 文字验证码工具类
...
public class CodeCaptchaUtil {
     ...
     * @author kuangq
     * @description 获取验证码的Base64
     * @date 2019-12-30 23:26
     */
    @SneakyThrows
    public ApiResult getCaptcha(RedisUtil redisUtil) {
        String nonceStr = GeneralUtil.getUuid();
        String value = nonceStr.substring(0, 4);
        redisUtil.setValue(PrefixConst.CAPTCHA + nonceStr, value, 5 * 60L);
