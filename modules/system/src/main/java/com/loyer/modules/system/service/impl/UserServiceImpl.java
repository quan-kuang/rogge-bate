...
public class UserServiceImpl implements UserService {
    ...
    /**
     * @param loginUser
     * @return com.loyer.common.security.entity.LoginUser
     * @author kuangq
     * @description 登录成功后的数据赋值
    ...
    public ApiResult messageLogin(User user) {
        ...
        //校验短信验证码
        if (!redisUtil.getValue(key).equals(user.getPassword())) {
    ...
    private void checkCaptcha(Captcha captcha) {
        ...
        //拼图验证
            ...
            //获取缓存验证码
            Integer value = redisUtil.getValue(key);
            //根据移动距离判断验证是否成功
     ...
     * @return void
     * @author kuangq
     * @description 保存登录时间，内部方法调用需要通过代理，并该方法属于public
    ...
    /**
     * @param user
     * @return com.loyer.system.common.entity.User
     * @author kuangq
     * @description 获取最新用户信息
