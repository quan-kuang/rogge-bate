...
public class FtpClientUtil {
    ...
    /**
     * @param localFilePath  上传文件所在路径全称（包含文件名以及文件名后缀）
     * @param serverFilePath 上传所在vsFtpd服务器路径
     * @return boolean
     * @author kuangq
     * @description 上传文件
    ...
    /**
     * @param serverFilePath 下载文件所在ftp服务器路径全称（包含文件名以及文件名后缀）
     * @param localFilePath  下载文件至本地路径
     * @return boolean
     * @author kuangq
     * @description 取回远程文件
